...
export type LicenseQuery = { viewer: { slug: { license: { id: string, name: string | null, text: string | null, pdf: { url: string | null } | null } | null } | null, licenses: Array<{ id: string, name: string | null, slug: { name: string | null } | null, pdf: { url: string | null } | null }> | null } };
...
export type RootLayoutQuery = { viewer: { url: string, fontCollections: { edges: Array<{ node: { id: string } | null } | null> | null } | null, pages: { edges: Array<{ node: { id: string, title: string | null, slug: { name: string | null } | null } | null } | null> | null } | null, footer: { edges: Array<{ node: { id: string, title: string | null, slug: { name: string | null } | null } | null } | null> | null } | null, settings: { title: string | null, description: string | null, footerText: string | null, htmlHead: string | null, faviconMarkup: string | null, uiFontStyle: { name: string, cssFamily: string | null, webfontSources: Array<{ url: string | null, format: string | null } | null> | null } | null } | null, logo: { url: string, meta: { width: number | null, height: number | null } } | null } };
