...
export type ArticleQuery = {
  viewer: {
    articlesTags: Array<string> | null;
    slug: {
      article: {
        title: string | null;
        ...
        images: Array<{
          ...
          meta: { width: number | null; height: number | null } | null;
        }> | null;
        pageMetadata: {
          title: string | null;
          description: string | null;
...
export type ArticlePathsQuery = {
  viewer: {
    articles: {
      edges: Array<{
        node: { slug: { name: string | null } | null } | null;
      } | null> | null;
    } | null;
  };
};
...
export type ArticleTagsQuery = {
  viewer: { articlesTags: Array<string> | null };
};
...
export type FontDetailCollectionFragment = {
  id: string;
  name: string;
  ...
  cssUrl: string | null;
  sku: { id: string } | null;
  bundles: Array<{ sku: { id: string } | null }> | null;
  fontStyles: Array<{
    name: string;
    ...
    variableInstances: Array<{
      name: string;
      coordinates: Array<{ axis: string; value: number }>;
    }> | null;
  }>;
};
...
export type FontDetailFragment = {
  ...
  featureStyle: {
    cssFamily: string | null;
    name: string;
    family: { cssUrl: string | null } | null;
  } | null;
  children: Array<{
    id: string;
    name: string;
...
export type FontCollectionCssFragment = {
  featureStyle: {
    cssFamily: string | null;
    name: string;
    webfontSources: Array<{
      format: string | null;
      url: string | null;
    } | null> | null;
    family: { cssUrl: string | null } | null;
...
export type LicenseQuery = {
  viewer: {
    slug: {
      license: { id: string; name: string | null; text: string | null } | null;
    } | null;
  };
};
...
export type LicensePathsQuery = {
  viewer: { licenses: Array<{ slug: { name: string | null } | null }> | null };
};
...
export type SitemapQuery = {
  viewer: {
    ...
    licenses: Array<{ slug: { name: string | null } | null }> | null;
  };
};
